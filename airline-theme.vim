...
function! airline#themes#meltheme#refresh() abort
	...
	let s:T = airline#themes#get_highlight2(['CursorLine', 'bg'], ['CursorLine', 'fg'])
	...
	let g:airline#themes#meltheme#palette.normal.airline_term = s:T
	...
	let g:airline#themes#meltheme#palette.normal_modified.airline_term = s:T
	...
	let g:airline#themes#meltheme#palette.inactive.airline_term = s:T
	let g:airline#themes#meltheme#palette.inactive_modified = { 'airline_c': s:M }
	let g:airline#themes#meltheme#palette.inactive_modified.airline_term = s:T
